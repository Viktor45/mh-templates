...
Этот шаблон создаёт автоматические цепочки прокси: сначала трафик идёт на российский сервер, а потом — в любую другую страну. Очень полезно, если вы хотите улучшить связанность своего трафика, например при белых списках. Но помните, при цепочках увеличивается пинг, т.к. используются ДВА ПРОКСИ механизма [dialer-proxy](https://wiki.metacubex.one/ru/config/proxies/dialer-proxy/).
